...
import AboutLab from "./screens/aboutLab";
import MyProfile from "./screens/myProfile/";
import LabMembers from "./screens/labMembers/";
import MemberProfile from "./screens/labMembers/memberProfile/";
import MyNotes from "./screens/myNotes/";
import LabNews from "./screens/labNews/";
import SendNotification from "./screens/sendNotifications/";
import NotificationContent from "./screens/sendNotifications/notificationContent";
import GroupNotification from "./screens/sendNotifications/groupNotification";
import IndividualNotification from "./screens/sendNotifications/individualNotification";
import ShareLocation from "./screens/shareLocation/";
import GroupLocation from "./screens/shareLocation/groupLocation";
import IndividualLocation from "./screens/shareLocation/individualLocation";
import LocationContent from "./screens/shareLocation/localtionContent";
import MyGroups from "./screens/myGroups/";
import CreateEditGroup from "./screens/myGroups/selection";
import EditGroup from "./screens/myGroups/editSelection";
...
import TakeSurvey from "./screens/survey/takeSurvey";
import SurveyCompletedScreen from "./screens/survey/surveyCompletedScreen";
import ShareDocument from "./screens/shareDocument/";
...
const Drawer = createDrawerNavigator(
  {
    ...
    LabMembers: { screen: LabMembers },
    MemberProfile: { screen: MemberProfile },
    MyNotes: { screen: MyNotes },
    LabNews: { screen: LabNews },
    SendNotification: { screen: SendNotification },
    MyGroups: { screen: MyGroups },
    Settings: { screen: Settings },
    ShareLocation: { screen: ShareLocation },
    Chat: { screen: Chat },
    OngoingProjects: { screen: OngoingProjects },
    Pipeline: {screen: Pipeline},
    Survey: {screen: Survey},
    ShareDocument: {screen: ShareDocument},
    Payment: {screen: Payment},
    AboutLab: {screen: AboutLab},
    // Login: { screen: Login },
    Home: { screen: Home }
...
const AppNavigator = createStackNavigator(
  {
    ...
    NotificationContent: { screen: NotificationContent },
    GroupNotification: { screen: GroupNotification },
    IndividualNotification: { screen: IndividualNotification },
    GroupLocation: { screen: GroupLocation },
    IndividualLocation: { screen: IndividualLocation },
    LocationContent: { screen: LocationContent },
    CreateEditGroup: { screen: CreateEditGroup },
    EditGroup: { screen: EditGroup },
    TakeSurvey: { screen: TakeSurvey},
    SurveyCompletedScreen: { screen: SurveyCompletedScreen}
  },
  {
